...
df_strat_ret['TOTAL']  = df_strat_ret.sum(axis=1)   #- df_signal.astype(bool).sum(axis=1) * 0.00002
df_strat_ret['Cum_TOTAL'] = df_strat_ret['TOTAL'] .cumsum()
df_strat_ret['DollarValue'] = df_strat_ret['TOTAL']*100000 - 16 #is the cost ie 4 * max(2bps or 2$)
